$(function(){
	...
	"airlines":[
		["Eurowings","Germany"],["Eagle Air","Uganda"],
		["China United Airlines","China"],["Gabon Airlines","Gabon"],
		["Aeroline GmbH","Germany"],["SOCHI AIR CHATER","Russia"]
	],
	"routes":[
		[1,2,3],[2,3,4],[1,3,5],
		[1,2,3],[2,3,4],[1,3,5]
...
alert(data.airportsFields[1]);
alert(data.airports[1][3]);

	var myChart=echarts.init(document.getElementById("echarts-world-chart"));
	myChart.showLoading();
		myChart.hideLoading();
	...
	n={
		...
		series:[
			...
			},
			{
				...
				markPoint:{data:[{name:"年最高",value:182.2,xAxis:7,yAxis:183,symbolSize:18},{name:"年最低",value:2.3,xAxis:11,yAxis:3}]},
				markLine:{data:[{type:"average",name:"平均值"}]}
			}
		]
	};
