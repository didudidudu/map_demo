...
CodePopover = (function(_super) {
  ...
  CodePopover.prototype._tpl = "<div class=\"code-settings\">\n  <div class=\"settings-field\">\n    <select class=\"select-lang\">\n      <option value=-1/index.html>选择程序语言</option>\n      <option value=bash/index.html>Bash</option>\n      <option value=c++/index.html>C++</option>\n      <option value=cs/index.html>C#</option>\n      <option value=css/index.html>CSS</option>\n      <option value=erlang/index.html>Erlang</option>\n      <option value=less/index.html>Less</option>\n      <option value=scss/index.html>Sass</option>\n      <option value=diff/index.html>Diff</option>\n      <option value=coffeeScript/index.html>CoffeeScript</option>\n      <option value=html/index.html>Html,XML</option>\n      <option value=json/index.html>JSON</option>\n      <option value=java/index.html>Java</option>\n      <option value=js/index.html>JavaScript</option>\n      <option value=markdown/index.html>Markdown</option>\n      <option value=oc/index.html>Objective C</option>\n      <option value=php/index.html>PHP</option>\n      <option value=perl/index.html>Perl</option>\n      <option value=python/index.html>Python</option>\n      <option value=ruby/index.html>Ruby</option>\n      <option value=sql/index.html>SQL</option>\n    </select>\n  </div>\n</div>";
...
LinkPopover = (function(_super) {
  ...
  LinkPopover.prototype.render = function() {
    var tpl;
    tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>" + (this._t('text')) + "</label>\n    <input class=\"link-text\" type=\"text\"/>\n    <a class=\"btn-unlink\" href=javascript-;/index.html"" + (this._t('removeLink')) + "\" tabindex=\"-1\"><span class=\"fa fa-unlink\"></span></a>\n  </div>\n  <div class=\"settings-field\">\n    <label>" + (this._t('linkUrl')) + "</label>\n    <input class=\"link-url\" type=\"text\"/>\n  </div>\n</div>";
...
ImagePopover = (function(_super) {
  ...
  ImagePopover.prototype.render = function() {
    var tpl;
    tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>" + (this._t('imageUrl')) + "</label>\n    <input class=\"image-src\" type=\"text\" tabindex=\"1\" />\n    <a class=\"btn-upload\" href=javascript-;/index.html"" + (this._t('uploadImage')) + "\" tabindex=\"-1\">\n      <span class=\"fa fa-upload\"></span>\n    </a>\n  </div>\n  <div class=\"settings-field\">\n    <label>" + (this._t('imageSize')) + "</label>\n    <input class=\"image-size\" id=\"image-width\" type=\"text\" tabindex=\"2\" />\n    <span class=\"times\">×</span>\n    <input class=\"image-size\" id=\"image-height\" type=\"text\" tabindex=\"3\" />\n    <a class=\"btn-restore\" href=javascript-;/index.html"" + (this._t('restoreImageSize')) + "\" tabindex=\"-1\">\n      <span class=\"fa fa-reply\"></span>\n    </a>\n  </div>\n</div>";
...
TableButton = (function(_super) {
  ...
  TableButton.prototype.renderMenu = function() {
    $("<div class=\"menu-create-table\">\n</div>\n<div class=\"menu-edit-table\">\n  <ul>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"deleteRow\"><span>" + (this._t('deleteRow')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"insertRowAbove\"><span>" + (this._t('insertRowAbove')) + " ( Ctrl + Alt + ↑ )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"insertRowBelow\"><span>" + (this._t('insertRowBelow')) + " ( Ctrl + Alt + ↓ )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"deleteCol\"><span>" + (this._t('deleteColumn')) + "</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"insertColLeft\"><span>" + (this._t('insertColumnLeft')) + " ( Ctrl + Alt + ← )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"insertColRight\"><span>" + (this._t('insertColumnRight')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=javascript-;/index.html"deleteTable\"><span>" + (this._t('deleteTable')) + "</span></a></li>\n  </ul>\n</div>").appendTo(this.menuWrapper);
